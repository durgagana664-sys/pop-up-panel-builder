...
const DownloadStatistics = () => {
  ...
  const filteredData = studentData.filter(student => {
    if (selectedClass !== "all" && !student.class.toLowerCase().includes(selectedClass.replace('a', '').trim())) {
      return false;
    }
    if (selectedSection !== "all" && !student.class.toLowerCase().includes(selectedSection)) {
      return false;
    }
    return true;
  });
